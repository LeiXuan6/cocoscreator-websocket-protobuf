    ...
    //  *
     ...
     onLoad () {
        ...
        this.ws.onopen = function (event) {
            console.log("open");
            var protoId = new Long(1001);
            //打开成功立刻进行发送
            if (self.ws.readyState === WebSocket.OPEN) {
                let loginBuilder = com.github.leixuan6.message.proto.C2L_Login.create({"platAccountId":"jacklei","platAccountName":"lei"});
                let loginByteBuf = com.github.leixuan6.message.proto.C2L_Login.encode(loginBuilder).finish();
        ...
        this.ws.onmessage = function (event) {
            ...
            let loginBuild = com.github.leixuan6.message.proto.L2C_Login.decode(bodyBuffer);       
